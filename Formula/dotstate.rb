class Dotstate < Formula
  ...
  if Hardware::CPU.intel?
    url "https://github.com/serkanyersen/dotstate/releases/download/v0.4.1/dotstate-x86_64-apple-darwin.tar.gz"
    sha256 "e26cbc8d46d94ca53bae9744dd02f34ceac833bfea7f52ccc842b939cb953716"
  else
    url "https://github.com/serkanyersen/dotstate/releases/download/v0.4.1/dotstate-aarch64-apple-darwin.tar.gz"
    sha256 "31787326ea2be7fb670b93a7ffcfa166260fc11529cc656cab51be4ce5a9a178"
  end
